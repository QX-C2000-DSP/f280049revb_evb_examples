...
void PMBus_configTarget(uint32_t base, uint32_t configWord)
{
    ...
    // PMBUS_PMBTCR_MAN_TARGET_ACK+PMBUS_PMBTCR_MAN_CMD+PMBUS_PMBTCR_RX_BYTE_ACK_CNT_M are combined
    // with manual ack,can't be resolved
...
//
//*****************************************************************************
void PMBus_putTargetData(uint32_t base, uint16_t *buffer, uint16_t nBytes, bool txPEC)
{
    //
    // Locals
    //
...
//
//*****************************************************************************
void PMBus_putControllerData(uint32_t base, uint16_t *buffer, uint16_t nBytes)
{
    //
    // Locals
    //
