...
//*****************************************************************************
#define IPC_O_ACK \
    0x10U // IPC incoming flag clear
          // (acknowledge) register
#define IPC_O_STS \
    0xCU               // IPC incoming flag status
                       // register
#define IPC_O_SET 0x0U // IPC remote flag set register
#define IPC_O_CLR \
    0x4U               // IPC remote flag clear
                       // register
#define IPC_O_FLG 0x8U // IPC remote flag status register
...
#define IPC_O_SENDCOM \
    0x100U // Local to Remote IPC Command
           // Register
#define IPC_O_SENDADDR \
    0x104U // Local to Remote IPC Address
           // Register
#define IPC_O_SENDDATA \
    0x108U // Local to Remote IPC Data
           // Register
#define IPC_O_REMOTEREPLY \
    0x11CU // Remote to Local IPC Reply
           // Data Register
#define IPC_O_RECVCOM \
    0x110U // Remote to Local IPC Command
           // Register
#define IPC_O_RECVADDR \
    0x114U // Remote to Local IPC Address
           // Register
#define IPC_O_RECVDATA \
    0x118U // Remote to Local IPC Data
           // Register
#define IPC_O_LOCALREPLY \
    0x10CU // Local to Remote IPC Reply
           // Data Register
#else
#define IPC_O_RECVCOM     0x100U // Remote to Local IPC Command
// Register
#define IPC_O_RECVADDR    0x104U // Remote to Local IPC Address
// Register
#define IPC_O_RECVDATA    0x108U // Remote to Local IPC Data
// Register
#define IPC_O_LOCALREPLY  0x11CU // Local to Remote IPC Reply
// Data Register
#define IPC_O_SENDCOM     0x110U // Local to Remote IPC Command
// Register
#define IPC_O_SENDADDR    0x114U // Local to Remote IPC Address
// Register
#define IPC_O_SENDDATA    0x118U // Local to Remote IPC Data
// Register
#define IPC_O_REMOTEREPLY 0x10CU // Remote to Local IPC Reply
// Data Register
#endif
