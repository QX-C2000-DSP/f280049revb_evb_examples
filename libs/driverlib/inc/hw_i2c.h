...
#define I2C_IER_XRDY 0x10U // Transmit-data-no-ready interrupt enable
...
#define I2C_STR_XRDY    0x10U   // Transmit-data-no-ready interrupt flag bit.
...
#define I2C_MDR_RM      0x80U   // Repeat Mode(TODO: not supported on F28004x)
