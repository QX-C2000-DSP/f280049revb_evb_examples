...
#define GPIO_O_GPBINV   0x6CU // GPIO B Input Inversion (GPIO32 to GPIO63)
#define GPIO_O_GPBODR   0x70U // GPIO B Open Drain Output Mode (GPIO32 to GPIO63)
...
#define GPIO_O_GPCCTRL  0xA0U // GPIO C Qualification Sampling Period (GPIO64 to GPIO95)
#define GPIO_O_GPCQSEL1 0xA4U // GPIO C Qualification Type (GPIO64 to GPIO79)
#define GPIO_O_GPCQSEL2 0xA8U // GPIO C Qualification Type (GPIO80 to GPIO95)
#define GPIO_O_GPCMUX1  0xACU // GPIO C Peripheral Mux (GPIO64 to GPIO95)
#define GPIO_O_GPCMUX2  0xB0U // GPIO C Peripheral Mux (GPIO64 to GPIO95)
#define GPIO_O_GPCDIR   0xB4U // GPIO C Direction (GPIO64 to GPIO95)
#define GPIO_O_GPCPUD   0xB8U // GPIO C Pull-Up Disable (GPIO64 to GPIO95)
#define GPIO_O_GPCINV   0xBCU // GPIO C Input Inversion (GPIO64 to GPIO95)
#define GPIO_O_GPCODR   0xC0U // GPIO C Open Drain Output Mode (GPIO64 to GPIO95)
#define GPIO_O_GPCGMUX1 0xC8U // GPIO C Peripheral Group Mux (GPIO64 to GPIO79)
#define GPIO_O_GPCGMUX2 0xCCU // GPIO C Peripheral Group Mux (GPIO80 to GPIO95)
#define GPIO_O_GPCLOCK  0xD0U // GPIO C Lock Register (GPIO64 to GPIO95)
#define GPIO_O_GPCCR    0xD4U // GPIO C Lock Commit Register (GPIO64 to GPIO95)

#define GPIO_O_GPDCTRL  0xF0U  // GPIO D Qualification Sampling Period (GPIO96 to GPIO127)
#define GPIO_O_GPDQSEL1 0xF4U  // GPIO D Qualification Type (GPIO96 to GPIO111)
#define GPIO_O_GPDQSEL2 0xF8U  // GPIO D Qualification Type (GPIO112 to GPIO127)
#define GPIO_O_GPDMUX1  0xFCU  // GPIO D Peripheral Mux (GPIO96 to GPIO111)
#define GPIO_O_GPDMUX2  0x100U // GPIO D Peripheral Mux (GPIO112 to GPIO127)
#define GPIO_O_GPDDIR   0x104U // GPIO D Direction (GPIO96 to GPIO127)
#define GPIO_O_GPDPUD   0x108U // GPIO D Pull-Up Disable (GPIO96 to GPIO127)
#define GPIO_O_GPDINV   0x10CU // GPIO D Input Inversion (GPIO96 to GPIO127)
#define GPIO_O_GPDODR   0x110U // GPIO D Open Drain Output Mode (GPIO96 to GPIO127)
#define GPIO_O_GPDGMUX1 0x118U // GPIO D Peripheral Group Mux (GPIO96 to GPIO111)
#define GPIO_O_GPDGMUX2 0x11CU // GPIO D Peripheral Group Mux (GPIO112 to GPIO127)
#define GPIO_O_GPDLOCK  0x120U // GPIO D Lock Register (GPIO96 to GPIO127)
#define GPIO_O_GPDCR    0x124U // GPIO D Lock Commit Register (GPIO96 to GPIO127)

#define GPIO_O_GPHCTRL  0x230U // GPIO H Qualification Sampling Period (GPIO224 to GPIO255)
#define GPIO_O_GPHQSEL1 0x234U // GPIO H Qualification Type (GPIO224 to GPIO239)
#define GPIO_O_GPHQSEL2 0x238U // GPIO H Qualification Type (GPIO240 to GPIO255)
#define GPIO_O_GPHDIR   0x244U // GPIO H Direction (GPIO224 to GPIO255)
#define GPIO_O_GPHPUD   0x248U // GPIO H Pull-Up Disable (GPIO224 to GPIO255)
#define GPIO_O_GPHINV   0x24CU // GPIO H Input Inversion (GPIO224 to GPIO255)
#define GPIO_O_GPHODR   0x250U // GPIO H Open Drain Output Mode (GPIO224 to GPIO255)
#define GPIO_O_GPHAMSEL 0x254U // GPIO H Analog Mode Select (GPIO224 to GPIO255)
#define GPIO_O_GPHLOCK  0x260U // GPIO H Lock Register (GPIO224 to GPIO255)
#define GPIO_O_GPHCR    0x264U // GPIO H Lock Commit Register (GPIO224 to GPIO255)
...
#define GPIO_O_GPCDAT    0x20U // GPIO C Data Register (GPIO64 to GPIO95)
#define GPIO_O_GPCSET    0x24U // GPIO C Output Set (GPIO64 to GPIO95)
#define GPIO_O_GPCCLEAR  0x28U // GPIO C Output Clear (GPIO64 to GPIO95)
#define GPIO_O_GPCTOGGLE 0x2CU // GPIO C Output Toggle (GPIO64 to GPIO95)
#define GPIO_O_GPDDAT    0x30U // GPIO D Data Register (GPIO96 to GPIO127)
#define GPIO_O_GPDSET    0x34U // GPIO D Output Set (GPIO96 to GPIO127)
#define GPIO_O_GPDCLEAR  0x38U // GPIO D Output Clear (GPIO96 to GPIO127)
#define GPIO_O_GPDTOGGLE 0x3CU // GPIO D Output Toggle (GPIO96 to GPIO127)
#define GPIO_O_GPHDAT    0x70U // GPIO H Data Register (GPIO224 to GPIO255)
#define GPIO_O_GPHSET    0x74U // GPIO H Output Set (GPIO224 to GPIO255)
#define GPIO_O_GPHCLEAR  0x78U // GPIO H Output Clear (GPIO224 to GPIO255)
#define GPIO_O_GPHTOGGLE 0x7CU // GPIO H Output Toggle (GPIO224 to GPIO255)
