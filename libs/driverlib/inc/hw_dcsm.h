...
#define DCSM_O_Z1_OTPSECLOCK        0x4U  // Zone 1 OTP Secure JTAG lock
...
#define DCSM_O_Z1_CSMKEY0           0x1CU // Zone 1 CSM Key 0
#define DCSM_O_Z1_CSMKEY1           0x20U // Zone 1 CSM Key 1
#define DCSM_O_Z1_CSMKEY2           0x24U // Zone 1 CSM Key 2
#define DCSM_O_Z1_CSMKEY3           0x28U // Zone 1 CSM Key 3
#define DCSM_O_Z1_CR                0x2CU // Zone 1 CSM Control Register
#define DCSM_O_B0_Z1_GRABSECTR      0x30U // Zone 1 Grab Flash BANK0 Sectors Register
#define DCSM_O_Z1_GRABRAMR          0x34U // Zone 1 Grab RAM Blocks Register
#define DCSM_O_B0_Z1_EXEONLYSECTR   0x38U // Zone 1 Flash BANK0 Execute_Only Sector Register
#define DCSM_O_Z1_EXEONLYRAMR       0x3CU // Zone 1 RAM Execute_Only Block Register

#define DCSM_O_B0_Z2_LINKPOINTER    0x0U  // Zone 2 Link Pointer for flash BANK0
#define DCSM_O_Z2_OTPSECLOCK        0x4U  // Zone 2 OTP Secure JTAG lock
#define DCSM_O_B0_Z2_LINKPOINTERERR 0x8U  // Link Pointer Error for flash BANK0
#define DCSM_O_Z2_CSMKEY0           0xCU  // Zone 2 CSM Key 0
#define DCSM_O_Z2_CSMKEY1           0x10U // Zone 2 CSM Key 1
#define DCSM_O_Z2_CSMKEY2           0x14U // Zone 2 CSM Key 2
#define DCSM_O_Z2_CSMKEY3           0x18U // Zone 2 CSM Key 3
#define DCSM_O_Z2_CR                0x1CU // Zone 2 CSM Control Register
#define DCSM_O_B0_Z2_GRABSECTR      0x20U // Zone 2 Grab Flash BANK0 Sectors Register
#define DCSM_O_Z2_GRABRAMR          0x24U // Zone 2 Grab RAM Blocks Register
#define DCSM_O_B0_Z2_EXEONLYSECTR   0x28U // Zone 2 Flash BANK0 Execute_Only Sector Register
#define DCSM_O_Z2_EXEONLYRAMR       0x2CU // Zone 2 RAM Execute_Only Block Register
...
#define DCSM_O_B1_SECTSTAT    0xCU  // Flash BANK1 Sectors Status Register
#define DCSM_O_SECERRSTAT     0x10U // Security Error Status Register
#define DCSM_O_SECERRCLR      0x14U // Security Error Clear Register
#define DCSM_O_SECERRFRC      0x18U // Security Error Force Register
#define DCSM_O_ECSL_VIOLATION 0x1U  // Disconnect The Jtag
#define DCSM_USER_CONFIG      0x20U
#define DCSM_USER_DATA        0x24U

#define DCSM_O_B1_Z1OTP_LINKPOINTER1 0x0U  // Zone 1 Link Pointer1 in Z1 OTP for flash BANK1
#define DCSM_O_B1_Z1OTP_LINKPOINTER2 0x8U  // Zone 1 Link Pointer2 in Z1 OTP for flash BANK1
#define DCSM_O_B1_Z1OTP_LINKPOINTER3 0x10U // Zone 1 Link Pointer3 in Z1 OTP for flash BANK1

#define DCSM_O_B1_Z2OTP_LINKPOINTER1 0x0U  // Zone 2 Link Pointer1 in Z2 OTP for flash BANK1
#define DCSM_O_B1_Z2OTP_LINKPOINTER2 0x8U  // Zone 2 Link Pointer2 in Z2 OTP for flash BANK1
#define DCSM_O_B1_Z2OTP_LINKPOINTER3 0x10U // Zone 2 Link Pointer3 in Z2 OTP for flash BANK1

#define DCSM_O_B1_Z1_LINKPOINTER    0x0U // Zone 1 Link Pointer for flash BANK1
#define DCSM_O_B1_Z1_LINKPOINTERERR 0x4U // Link Pointer Error for flash BANK1
#define DCSM_O_B1_Z1_GRABSECTR      0x8U // Zone 1 Grab Flash BANK1 Sectors Register
#define DCSM_O_B1_Z1_EXEONLYSECTR   0xCU // Zone 1 Flash BANK1 Execute_Only Sector Register

#define DCSM_O_B1_Z2_LINKPOINTER    0x0U // Zone 2 Link Pointer for flash BANK1
#define DCSM_O_B1_Z2_LINKPOINTERERR 0x4U // Link Pointer Error for flash BANK1
#define DCSM_O_B1_Z2_GRABSECTR      0x8U // Zone 2 Grab Flash BANK1 Sectors Register
#define DCSM_O_B1_Z2_EXEONLYSECTR   0xCU // Zone 2 Flash BANK1 Execute_Only Sector Register
...
#define DCSM_B0_Z1_LINKPOINTER_LINKPOINTER_M \
    0x1FFFFFFFU // Zone1 LINK Pointer for zone Flash
                // BANK0
...
#define DCSM_Z1_OTPSECLOCK_JTAGLOCK_M 0xFU // Zone1 Password Lock.
...
#define DCSM_B0_Z1_LINKPOINTERERR_Z1_LINKPOINTERERR_M \
    0x1FFFFFFFU // Error to Resolve Z1 Link
...
//
//*************************************************************************************************
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT0 \
    0x1U // Execute-Only Flash Sector 0 in Flash
         // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT1 \
    0x2U // Execute-Only Flash Sector 1 in Flash
         // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT2 \
    0x4U // Execute-Only Flash Sector 2 in Flash
         // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT3 \
    0x8U // Execute-Only Flash Sector 3 in Flash
         // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT4 \
    0x10U // Execute-Only Flash Sector 4 in Flash
          // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT5 \
    0x20U // Execute-Only Flash Sector 5 in Flash
          // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT6 \
    0x40U // Execute-Only Flash Sector 6 in Flash
          // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT7 \
    0x80U // Execute-Only Flash Sector 7 in Flash
          // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT8 \
    0x100U // Execute-Only Flash Sector 8 in Flash
           // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT9 \
    0x200U // Execute-Only Flash Sector 9 in Flash
           // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT10 \
    0x400U // Execute-Only Flash Sector 10 in Flash
           // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT11 \
    0x800U // Execute-Only Flash Sector 11 in Flash
           // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT12 \
    0x1000U // Execute-Only Flash Sector 12 in Flash
            // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT13 \
    0x2000U // Execute-Only Flash Sector 13 in Flash
            // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT14 \
    0x4000U // Execute-Only Flash Sector 14 in Flash
            // BANK0
#define DCSM_B0_Z1_EXEONLYSECTR_EXEONLY_SECT15 \
    0x8000U // Execute-Only Flash Sector 15 in Flash
            // BANK0
...
#define DCSM_Z2_OTPSECLOCK_JTAGLOCK_M 0xFU // Zone1 Password Lock.
...
#define DCSM_B0_Z2_LINKPOINTERERR_Z2_LINKPOINTERERR_M \
    0x1FFFFFFFU // Error to Resolve Z2 Link
                // pointer from OTP loaded values
...
//
//*************************************************************************************************
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT0 \
    0x1U // Execute-Only Flash Sector 0 in Flash
         // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT1 \
    0x2U // Execute-Only Flash Sector 1 in Flash
         // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT2 \
    0x4U // Execute-Only Flash Sector 2 in Flash
         // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT3 \
    0x8U // Execute-Only Flash Sector 3 in Flash
         // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT4 \
    0x10U // Execute-Only Flash Sector 4 in Flash
          // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT5 \
    0x20U // Execute-Only Flash Sector 5 in Flash
          // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT6 \
    0x40U // Execute-Only Flash Sector 6 in Flash
          // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT7 \
    0x80U // Execute-Only Flash Sector 7 in Flash
          // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT8 \
    0x100U // Execute-Only Flash Sector 8 in Flash
           // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT9 \
    0x200U // Execute-Only Flash Sector 9 in Flash
           // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT10 \
    0x400U // Execute-Only Flash Sector 10 in Flash
           // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT11 \
    0x800U // Execute-Only Flash Sector 11 in Flash
           // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT12 \
    0x1000U // Execute-Only Flash Sector 12 in Flash
            // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT13 \
    0x2000U // Execute-Only Flash Sector 13 in Flash
            // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT14 \
    0x4000U // Execute-Only Flash Sector 14 in Flash
            // BANK0
#define DCSM_B0_Z2_EXEONLYSECTR_EXEONLY_SECT15 \
    0x8000U // Execute-Only Flash Sector 15 in Flash
            // BANK0
...
#define DCSM_B1_Z1_LINKPOINTERERR_Z1_LINKPOINTERERR_M \
    0x1FFFFFFFU // Error to Resolve Z1 Link
                // pointer from OTP loaded values
...
//
//*************************************************************************************************
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT0 \
    0x1U // Execute-Only Flash Sector 0 in Flash
         // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT1 \
    0x2U // Execute-Only Flash Sector 1 in Flash
         // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT2 \
    0x4U // Execute-Only Flash Sector 2 in Flash
         // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT3 \
    0x8U // Execute-Only Flash Sector 3 in Flash
         // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT4 \
    0x10U // Execute-Only Flash Sector 4 in Flash
          // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT5 \
    0x20U // Execute-Only Flash Sector 5 in Flash
          // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT6 \
    0x40U // Execute-Only Flash Sector 6 in Flash
          // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT7 \
    0x80U // Execute-Only Flash Sector 7 in Flash
          // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT8 \
    0x100U // Execute-Only Flash Sector 8 in Flash
           // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT9 \
    0x200U // Execute-Only Flash Sector 9 in Flash
           // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT10 \
    0x400U // Execute-Only Flash Sector 10 in Flash
           // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT11 \
    0x800U // Execute-Only Flash Sector 11 in Flash
           // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT12 \
    0x1000U // Execute-Only Flash Sector 12 in Flash
            // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT13 \
    0x2000U // Execute-Only Flash Sector 13 in Flash
            // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT14 \
    0x4000U // Execute-Only Flash Sector 14 in Flash
            // BANK1
#define DCSM_B1_Z1_EXEONLYSECTR_EXEONLY_SECT15 \
    0x8000U // Execute-Only Flash Sector 15 in Flash
            // BANK1
...
#define DCSM_B1_Z2_LINKPOINTERERR_Z2_LINKPOINTERERR_M \
    0x1FFFFFFFU // Error to Resolve Z2 Link
                // pointer from OTP loaded values
...
//
//*************************************************************************************************
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT0 \
    0x1U // Execute-Only Flash Sector 0 in Flash
         // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT1 \
    0x2U // Execute-Only Flash Sector 1 in Flash
         // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT2 \
    0x4U // Execute-Only Flash Sector 2 in Flash
         // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT3 \
    0x8U // Execute-Only Flash Sector 3 in Flash
         // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT4 \
    0x10U // Execute-Only Flash Sector 4 in Flash
          // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT5 \
    0x20U // Execute-Only Flash Sector 5 in Flash
          // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT6 \
    0x40U // Execute-Only Flash Sector 6 in Flash
          // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT7 \
    0x80U // Execute-Only Flash Sector 7 in Flash
          // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT8 \
    0x100U // Execute-Only Flash Sector 8 in Flash
           // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT9 \
    0x200U // Execute-Only Flash Sector 9 in Flash
           // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT10 \
    0x400U // Execute-Only Flash Sector 10 in Flash
           // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT11 \
    0x800U // Execute-Only Flash Sector 11 in Flash
           // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT12 \
    0x1000U // Execute-Only Flash Sector 12 in Flash
            // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT13 \
    0x2000U // Execute-Only Flash Sector 13 in Flash
            // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT14 \
    0x4000U // Execute-Only Flash Sector 14 in Flash
            // BANK1
#define DCSM_B1_Z2_EXEONLYSECTR_EXEONLY_SECT15 \
    0x8000U // Execute-Only Flash Sector 15 in Flash
            // BANK1
