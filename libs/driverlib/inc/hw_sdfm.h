...
#define SDFM_SDDATA1_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDDATFIFO1_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDCMPHZ1_HLTZ_M \
    0x7FFFU // High-level threshold (Z) for the comparator filter
            // output
...
#define SDFM_SDDATA2_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDDATFIFO2_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDDATA3_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDDATFIFO3_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDDATA4_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
...
#define SDFM_SDDATFIFO4_DATA32HI_M \
    0xFFFF0000U // Hi-order 16b in 32b mode, 16-bit Data in 16b
                // mode
