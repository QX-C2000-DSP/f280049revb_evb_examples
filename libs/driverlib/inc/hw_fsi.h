...
#define FSI_O_TX_BUF_BASE(i)     (0x44U + 4 * (i)) // (0 <= i < 16) Base address for trans buffer
...
#define FSI_O_RX_INT1_CTRL       0x40U             // Receive interrupt control register
...
#define FSI_O_RX_BUF_BASE(i)     (0x50U + 4 * (i)) // (0 <= i < 16) Base address for receive data buffer
