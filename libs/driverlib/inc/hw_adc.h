...
//
//*************************************************************************************************
#define ADC_O_CTL1       0x0U  // WR    // ADC Control 1 Register
#define ADC_O_CTL2       0x4U  // WR    // ADC Control 2 Register
#define ADC_O_BURSTCTL   0x8U  // WR    // ADC Burst Control Register
#define ADC_O_INTFLG     0xcU  // R     // ADC Interrupt Flag Register
#define ADC_O_INTFLGCLR  0x10U // WR    // ADC Interrupt Flag Clear Register
#define ADC_O_INTOVF     0x14U // R     // ADC Interrupt Overflow Register
#define ADC_O_INTOVFCLR  0x18U // WR    // ADC Interrupt Overflow Clear Registerv
#define ADC_O_INTSEL1N2  0x1cU // WR    // ADC Interrupt 1 and 2 Selection Register
#define ADC_O_INTSEL3N4  0x20U // WR    // ADC Interrupt 3 and 4 Selection Register
#define ADC_O_SOCPRICTL  0x24U // WR    // ADC SOC Priority Control Register
#define ADC_O_INTSOCSEL1 0x28U // WR    // ADC Interrupt SOC Selection 1 Register
#define ADC_O_INTSOCSEL2 0x2cU // WR    // ADC Interrupt SOC Selection 2 Register
#define ADC_O_SOCFLG1    0x30U // R     // ADC SOC Flag 1 Register
#define ADC_O_SOCFRC1    0x34U // RW1S  // ADC SOC Force 1 Register
#define ADC_O_SOCOVF1    0x38U // R     // ADC SOC Overflow 1 Register
#define ADC_O_SOCOVFCLR1 0x3cU // RW1S  // ADC SOC Overflow Clear 1 Register
#define ADC_O_SOC0CTL    0x40U // WR    // ADC SOC0 Control Register
#define ADC_O_SOC1CTL    0x44U // WR    // ADC SOC1 Control Register
#define ADC_O_SOC2CTL    0x48U // WR    // ADC SOC2 Control Register
#define ADC_O_SOC3CTL    0x4cU // WR    // ADC SOC3 Control Register
#define ADC_O_SOC4CTL    0x50U // WR    // ADC SOC4 Control Register
#define ADC_O_SOC5CTL    0x54U // WR    // ADC SOC5 Control Register
#define ADC_O_SOC6CTL    0x58U // WR    // ADC SOC6 Control Register
#define ADC_O_SOC7CTL    0x5cU // WR    // ADC SOC7 Control Register
#define ADC_O_SOC8CTL    0x60U // WR    // ADC SOC8 Control Register
#define ADC_O_SOC9CTL    0x64U // WR    // ADC SOC9 Control Register
#define ADC_O_SOC10CTL   0x68U // WR    // ADC SOC10 Control Register
#define ADC_O_SOC11CTL   0x6cU // WR    // ADC SOC11 Control Register
#define ADC_O_SOC12CTL   0x70U // WR    // ADC SOC12 Control Register
#define ADC_O_SOC13CTL   0x74U // WR    // ADC SOC13 Control Register
#define ADC_O_SOC14CTL   0x78U // WR    // ADC SOC14 Control Register
#define ADC_O_SOC15CTL   0x7cU // WR    // ADC SOC15 Control Register
#define ADC_O_EVTSTAT    0x80U // R     // ADC Event Status Register
#define ADC_O_EVTCLR     0x84U // WR    // ADC Event Clear Register
#define ADC_O_EVTSEL     0x88U // WR    // ADC Event Selection Register
#define ADC_O_EVTINTSEL  0x8cU // WR    // ADC Event Interrupt Selection Register
// #define ADC_O_OSDETECT       0x90U  //   // ADC Open and Shorts Detect Register
#define ADC_O_COUNTER 0x94U // R    // ADC Counter Register
#define ADC_O_REV     0x98U // R    // ADC Revision Register
// #define ADC_O_OFFTRIM        0x9cU  //   // ADC Offset Trim Register
#define ADC_O_PPB1CONFIG 0xa0U  // WR   // ADC PPB1 Config Register
#define ADC_O_PPB1STAMP  0xa4U  // R    // ADC PPB1 Sample Delay Time Stamp Register
#define ADC_O_PPB1OFFCAL 0xa8U  // WR   // ADC PPB1 Offset Calibration Register
#define ADC_O_PPB1OFFREF 0xacU  // WR   // ADC PPB1 Offset Reference Register
#define ADC_O_PPB1TRIPHI 0xb0U  // WR   // ADC PPB1 Trip High Register
#define ADC_O_PPB1TRIPLO 0xb4U  // WR   // ADC PPB1 Trip Low/Trigger Time Stamp Register
#define ADC_O_PPB2CONFIG 0xb8U  // WR   // ADC PPB2 Config Register
#define ADC_O_PPB2STAMP  0xbcU  // R    // ADC PPB2 Sample Delay Time Stamp Register
#define ADC_O_PPB2OFFCAL 0xc0U  // WR   // ADC PPB2 Offset Calibration Register
#define ADC_O_PPB2OFFREF 0xc4U  // WR   // ADC PPB2 Offset Reference Register
#define ADC_O_PPB2TRIPHI 0xc8U  // WR   // ADC PPB2 Trip High Register
#define ADC_O_PPB2TRIPLO 0xccU  // WR   // ADC PPB2 Trip Low/Trigger Time Stamp Register
#define ADC_O_PPB3CONFIG 0xd0U  // WR   // ADC PPB3 Config Register
#define ADC_O_PPB3STAMP  0xd4U  // R    // ADC PPB3 Sample Delay Time Stamp Register
#define ADC_O_PPB3OFFCAL 0xd8U  // WR   // ADC PPB3 Offset Calibration Register
#define ADC_O_PPB3OFFREF 0xdcU  // WR   // ADC PPB3 Offset Reference Register
#define ADC_O_PPB3TRIPHI 0xe0U  // WR   // ADC PPB3 Trip High Register
#define ADC_O_PPB3TRIPLO 0xe4U  // WR   // ADC PPB3 Trip Low/Trigger Time Stamp Register
#define ADC_O_PPB4CONFIG 0xe8U  // WR   // ADC PPB4 Config Register
#define ADC_O_PPB4STAMP  0xecU  // R    // ADC PPB4 Sample Delay Time Stamp Register
#define ADC_O_PPB4OFFCAL 0xf0U  // WR   // ADC PPB4 Offset Calibration Register
#define ADC_O_PPB4OFFREF 0xf4U  // WR   // ADC PPB4 Offset Reference Register
#define ADC_O_PPB4TRIPHI 0xf8U  // WR   // ADC PPB4 Trip High Register
#define ADC_O_PPB4TRIPLO 0xfcU  // WR   // ADC PPB4 Trip Low/Trigger Time Stamp Register
#define ADC_O_INTCYCLE   0x100U // WR   // ADC Early Interrupt Generation Cycle
#define ADC_O_INLTRIM1   0x104U // R    // ADC Linearity Trim 1 Register
#define ADC_O_INLTRIM2   0x108U // R    // ADC Linearity Trim 2 Register

#define ADC_O_RESULT0    0x0U  // 0x0U    // ADC Result 0 Register
#define ADC_O_RESULT1    0x4U  // 0x1U    // ADC Result 1 Register
#define ADC_O_RESULT2    0x8U  // 0x2U    // ADC Result 2 Register
#define ADC_O_RESULT3    0xcU  // 0x3U    // ADC Result 3 Register
#define ADC_O_RESULT4    0x10U // 0x4U    // ADC Result 4 Register
#define ADC_O_RESULT5    0x14U // 0x5U    // ADC Result 5 Register
#define ADC_O_RESULT6    0x18U // 0x6U    // ADC Result 6 Register
#define ADC_O_RESULT7    0x1cU // 0x7U    // ADC Result 7 Register
#define ADC_O_RESULT8    0x20U // 0x8U    // ADC Result 8 Register
#define ADC_O_RESULT9    0x24U // 0x9U    // ADC Result 9 Register
#define ADC_O_RESULT10   0x28U // 0xAU    // ADC Result 10 Register
#define ADC_O_RESULT11   0x2cU // 0xBU    // ADC Result 11 Register
#define ADC_O_RESULT12   0x30U // 0xCU    // ADC Result 12 Register
#define ADC_O_RESULT13   0x34U // 0xDU    // ADC Result 13 Register
#define ADC_O_RESULT14   0x38U // 0xEU    // ADC Result 14 Register
#define ADC_O_RESULT15   0x3cU // 0xFU    // ADC Result 15 Register
#define ADC_O_PPB1RESULT 0x40U // 0x10U   // ADC Post Processing Block 1 Result Register
#define ADC_O_PPB2RESULT 0x44U // 0x12U   // ADC Post Processing Block 2 Result Register
#define ADC_O_PPB3RESULT 0x48U // 0x14U   // ADC Post Processing Block 3 Result Register
#define ADC_O_PPB4RESULT 0x4cU // 0x16U   // ADC Post Processing Block 4 Result Register
...
#define ADC_CTL2_PRESCALE_M 0x1FU // ADC Clock Prescaler
...
#define ADC_PPB1CONFIG_CBCEN      0x40U // Cycle By Cycle Enable
...
#define ADC_PPB1TRIPHI_HSIGN     0x1000U // High Limit Sign Bit
...
#define ADC_PPB1TRIPLO_LSIGN      0x1000U // Low Limit Sign Bit
...
#define ADC_PPB2CONFIG_CBCEN      0x40U // Cycle By Cycle Enable
...
#define ADC_PPB2TRIPLO_LSIGN      0x1000U // Low Limit Sign Bit
...
#define ADC_PPB3CONFIG_CBCEN      0x40U // Cycle By Cycle Enable
...
#define ADC_PPB3TRIPHI_HSIGN     0x1000U // High Limit Sign Bit
...
#define ADC_PPB3TRIPLO_LSIGN      0x1000U // Low Limit Sign Bit
...
#define ADC_PPB4CONFIG_CBCEN      0x40U // Cycle By Cycle Enable
...
#define ADC_PPB4TRIPHI_HSIGN     0x1000U // High Limit Sign Bit
...
#define ADC_PPB4TRIPLO_LSIGN      0x1000U // Low Limit Sign Bit
...
#define ADC_PPB4RESULT_PPBRESULT_M 0x1FFFU // ADC Post Processing Block Result
#define ADC_PPB4RESULT_SIGN_S      13U
#define ADC_PPB4RESULT_SIGN_M      0xFFFFe000U // Sign Extended Bits
