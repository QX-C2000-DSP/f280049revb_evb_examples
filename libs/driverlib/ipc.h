...
#if IPC_MSGQ_SUPPORT == 1U
    struct IPC_PutBuffer_t *IPC_PutBuffer;
    struct IPC_GetBuffer_t *IPC_GetBuffer;
#endif
} IPC_Instance_t;
...
//
//*****************************************************************************
extern bool IPC_sendCommand(IPC_Type_t ipcType, uint32_t flags, bool addrCorrEnable,
...
//
//*****************************************************************************
extern bool IPC_readCommand(IPC_Type_t ipcType, uint32_t flags, bool addrCorrEnable,
    uint32_t *command, uint32_t *addr, uint32_t *data);
...
{
    IPC_Instance[ipcType].IPC_SendCmd_Reg->IPC_LOCALREPLY = data;
}
...
{
    return (IPC_Instance[ipcType].IPC_RecvCmd_Reg->IPC_REMOTEREPLY);
}
...
//
//*****************************************************************************
static inline uint64_t IPC_Unsupported_getCounter(IPC_Type_t ipcType)
{
#if 0
    //
...
//
//*****************************************************************************
extern void IPC_registerInterrupt(IPC_Type_t ipcType, uint32_t ipcInt, void (*pfnHandler)(void));
...
//
//*****************************************************************************
extern void IPC_initMessageQueue(IPC_Type_t ipcType, volatile IPC_MessageQueue_t *msgQueue,
...
//
//*****************************************************************************
extern bool IPC_sendMessageToQueue(IPC_Type_t ipcType, volatile IPC_MessageQueue_t *msgQueue,
...
//
//*****************************************************************************
extern bool IPC_readMessageFromQueue(IPC_Type_t ipcType, volatile IPC_MessageQueue_t *msgQueue,
    bool addrCorrEnable, IPC_Message_t *msg, bool block);
#endif
//*****************************************************************************
//
