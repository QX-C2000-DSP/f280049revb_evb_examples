...
static inline void FSI_stopTxFlush(uint32_t base)
{
    ...
    EALLOW;
    HWREGH(base + FSI_O_TX_MAIN_CTRL)
        = (((~FSI_TX_MAIN_CTRL_FLUSH) & HWREGH(base + FSI_O_TX_MAIN_CTRL))
...
static inline void FSI_configPrescalar(uint32_t base, uint16_t preScaleValue)
{
    ...
    // Set prescalar value
    //
    HWREGH(base + FSI_O_TX_CLK_CTRL)
        = (HWREGH(base + FSI_O_TX_CLK_CTRL) & (~FSI_TX_CLK_CTRL_PRESCALE_VAL_M))
          | (preScaleValue << FSI_TX_CLK_CTRL_PRESCALE_VAL_S);
    EDIS;
}
...
static inline void FSI_setTxDataWidth(uint32_t base, FSI_DataWidth dataWidth)
{
    ...
    HWREGH(base + FSI_O_TX_OPER_CTRL_LO)
        = (HWREGH(base + FSI_O_TX_OPER_CTRL_LO) & (~FSI_TX_OPER_CTRL_LO_DATA_WIDTH_M))
          | (uint16_t)dataWidth;
    EDIS;
}
...
static inline void FSI_setTxStartMode(uint32_t base, FSI_TxStartMode txStartMode)
{
    ...
    EALLOW;
    HWREGH(base + FSI_O_TX_OPER_CTRL_LO)
        = (HWREGH(base + FSI_O_TX_OPER_CTRL_LO) & (~FSI_TX_OPER_CTRL_LO_START_MODE_M))
...
static inline void FSI_setTxExtFrameTrigger(uint32_t base, uint16_t extInputNum)
{
    ...
    HWREGH(base + FSI_O_TX_OPER_CTRL_HI)
        = (HWREGH(base + FSI_O_TX_OPER_CTRL_HI) & (~FSI_TX_OPER_CTRL_HI_EXT_TRIG_SEL_M))
...
static inline void FSI_setTxFrameType(uint32_t base, FSI_FrameType frameType)
{
    ...
    HWREGH(base + FSI_O_TX_FRAME_CTRL)
        = (HWREGH(base + FSI_O_TX_FRAME_CTRL) & (~FSI_TX_FRAME_CTRL_FRAME_TYPE_M))
          | (uint16_t)frameType;
}
...
static inline void FSI_setTxSoftwareFrameSize(uint32_t base, uint16_t nWords)
{
    ...
    HWREGH(base + FSI_O_TX_FRAME_CTRL)
        = (HWREGH(base + FSI_O_TX_FRAME_CTRL) & (~FSI_TX_FRAME_CTRL_N_WORDS_M))
          | ((nWords - 1U) << FSI_TX_FRAME_CTRL_N_WORDS_S);
}
...
static inline void FSI_setTxFrameTag(uint32_t base, FSI_FrameTag frameTag)
{
    ...
    HWREGH(base + FSI_O_TX_FRAME_TAG_UDATA)
        = (HWREGH(base + FSI_O_TX_FRAME_TAG_UDATA) & (~FSI_TX_FRAME_TAG_UDATA_FRAME_TAG_M))
          | (uint16_t)frameTag;
}
...
static inline void FSI_setTxUserDefinedData(uint32_t base, uint16_t userDefData)
{
    ...
    HWREGH(base + FSI_O_TX_FRAME_TAG_UDATA)
        = (HWREGH(base + FSI_O_TX_FRAME_TAG_UDATA) & (~FSI_TX_FRAME_TAG_UDATA_USER_DATA_M))
...
//
//*****************************************************************************
static inline void FSI_enableTxPingTimer(
    uint32_t base, uint32_t refValue, FSI_FrameTag pingFrameTag)
{
    //
    // Check the arguments.
    //
...
static inline void FSI_enableTxExtPingTrigger(uint32_t base, uint16_t extTrigSel)
{
    ...
    //
    HWREGH(base + FSI_O_TX_PING_CTRL)
        = (HWREGH(base + FSI_O_TX_PING_CTRL) & (~FSI_TX_PING_CTRL_EXT_TRIG_SEL_M))
          | (extTrigSel << FSI_TX_PING_CTRL_EXT_TRIG_SEL_S);
    //
...
//
//*****************************************************************************
static inline void FSI_disableTxExtPingTrigger(uint32_t base)
{
    //
    // Check the arguments.
    //
...
static inline void FSI_disableTxInterrupt(uint32_t base, FSI_InterruptNum intNum, uint16_t intFlags)
{
    ...
    {
        HWREGH(base + FSI_O_TX_INT_CTRL)
            &= ((~(intFlags & FSI_TX_EVTMASK) << FSI_TX_INT2_CTRL_S) | 0xFFU);
    }
...
//
//*****************************************************************************
extern void FSI_writeTxBuffer(
    uint32_t base, const uint16_t array[], uint16_t length, uint16_t bufOffset);
...
static inline void FSI_disableRxInternalLoopback(uint32_t base)
{
    ...
    EALLOW;
    HWREGH(base + FSI_O_RX_MAIN_CTRL)
        = (HWREGH(base + FSI_O_RX_MAIN_CTRL) & (~FSI_RX_MAIN_CTRL_INT_LOOPBACK))
...
static inline void FSI_disableRxSPIPairing(uint32_t base)
{
    ...
    EALLOW;
    HWREGH(base + FSI_O_RX_MAIN_CTRL)
        = (HWREGH(base + FSI_O_RX_MAIN_CTRL) & (~FSI_RX_MAIN_CTRL_SPI_PAIRING))
          | (FSI_CTRL_REG_KEY << FSI_RX_MAIN_CTRL_KEY_S);
    EDIS;
}
...
static inline void FSI_setRxDataWidth(uint32_t base, FSI_DataWidth dataWidth)
{
    ...
    EALLOW;
    HWREGH(base + FSI_O_RX_OPER_CTRL)
        = (HWREGH(base + FSI_O_RX_OPER_CTRL) & (~FSI_RX_OPER_CTRL_DATA_WIDTH_M))
          | (uint16_t)dataWidth;
    EDIS;
}
...
static inline void FSI_setRxSoftwareFrameSize(uint32_t base, uint16_t nWords)
{
    ...
    EALLOW;
    HWREGH(base + FSI_O_RX_OPER_CTRL)
        = (HWREGH(base + FSI_O_RX_OPER_CTRL) & (~FSI_RX_OPER_CTRL_N_WORDS_M))
          | ((nWords - 1U) << FSI_RX_OPER_CTRL_N_WORDS_S);
    EDIS;
}
...
static inline uint16_t FSI_getRxComputedCRC(uint32_t base)
{
    ...
    return ((HWREGH(base + FSI_O_RX_CRC_INFO) & FSI_RX_CRC_INFO_CALC_CRC_M)
            >> FSI_RX_CRC_INFO_CALC_CRC_S);
}
...
static inline void FSI_enableRxInterrupt(uint32_t base, FSI_InterruptNum intNum, uint16_t intFlags)
{
    ...
    {
        HWREGH(base + FSI_O_RX_INT1_CTRL) |= ((intFlags & FSI_RX_EVTMASK) << 16);
    }
...
//
//*****************************************************************************
extern void FSI_configRxDelayLine(
    uint32_t base, FSI_RxDelayTapType delayTapType, uint16_t tapValue);
