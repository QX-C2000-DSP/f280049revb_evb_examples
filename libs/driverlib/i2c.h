...
#define I2C_STR_INTMASK                                                                       \
    ((uint16_t)I2C_INT_ARB_LOST | (uint16_t)I2C_INT_NO_ACK | (uint16_t)I2C_INT_REG_ACCESS_RDY \
        | (uint16_t)I2C_INT_RX_DATA_RDY | (uint16_t)I2C_INT_TX_DATA_RDY                       \
        | (uint16_t)I2C_INT_STOP_CONDITION | (uint16_t)I2C_INT_ADDR_TARGET)
...
typedef enum
{
    ...
    I2C_FIFO_TXFULL = 0x000FU //!< Transmit FIFO full
} I2C_TxFIFOLevel;
...
typedef enum
{
    ...
    I2C_FIFO_RXFULL = 0x000FU //!< Receive FIFO full
} I2C_RxFIFOLevel;
...
//
//*****************************************************************************
extern void I2C_initController(
    uint32_t base, uint32_t sysclkHz, uint32_t bitRate, I2C_DutyCycle dutyCycle);
...
//
//*****************************************************************************
extern void I2C_initControllerModuleFrequency(uint32_t base, uint32_t sysclkHz, uint32_t bitRate,
...
extern void I2C_configureModuleClockFrequency(
    uint32_t base, uint32_t sysclkHz, uint32_t moduleFrequency);
