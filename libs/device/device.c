...
void Device_init(void)
{
    ...
    if (SysCtl_getClock(DEVICE_OSCSRC_FREQ) > 100000000)
        Flash_setClkDiv(4); // flash max support 100Mhz clock
...
void Device_enableAllPeripherals(void)
{
    ...
    SysCtl_enablePeripheral(SYSCTL_PERIPH_CLK_CPU2_TIMER0);
    SysCtl_enablePeripheral(SYSCTL_PERIPH_CLK_CPU2_TIMER1);
    SysCtl_enablePeripheral(SYSCTL_PERIPH_CLK_CPU2_TIMER2);
    ...
    SysCtl_enablePeripheral(SYSCTL_PERIPH_CLK_ADCG);
    SysCtl_enablePeripheral(SYSCTL_PERIPH_CLK_ADCH);
