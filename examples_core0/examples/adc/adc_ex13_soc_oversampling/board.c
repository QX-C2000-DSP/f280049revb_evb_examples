...
void myADC0_init()
{
    ...
    //
    ADC_setupSOC(
        myADC0_BASE, ADC_SOC_NUMBER1, ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN1, ADC_SAMPLE_WINDOW_10);
    ...
    //
    ADC_setupSOC(
        myADC0_BASE, ADC_SOC_NUMBER2, ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN2, ADC_SAMPLE_WINDOW_10);
    ...
    //
    ADC_setupSOC(
        myADC0_BASE, ADC_SOC_NUMBER3, ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN2, ADC_SAMPLE_WINDOW_10);
    ...
    //
    ADC_setupSOC(
        myADC0_BASE, ADC_SOC_NUMBER4, ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN2, ADC_SAMPLE_WINDOW_10);
    ...
    //
    ADC_setupSOC(
        myADC0_BASE, ADC_SOC_NUMBER5, ADC_TRIGGER_EPWM1_SOCA, ADC_CH_ADCIN2, ADC_SAMPLE_WINDOW_10);
