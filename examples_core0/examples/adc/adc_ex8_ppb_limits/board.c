...
void myADC0_init()
{
    ...
    ADC_enablePPBEventInterrupt(myADC0_BASE, ADC_PPB_NUMBER1, (ADC_EVT_TRIPHI | ADC_EVT_TRIPLO));
    ADC_disablePPBEventInterrupt(myADC0_BASE, ADC_PPB_NUMBER1, (ADC_EVT_ZERO));
    ...
    ADC_setPPBTripLimits(myADC0_BASE, ADC_PPB_NUMBER1, 3000, 1000);
...
void INTERRUPT_init()
{
    ...
    // Interrupt Setings for INT_myADC0_EVT
    Interrupt_register(INT_myADC0_EVT, &adcAEvtISR);
    Interrupt_enable(INT_myADC0_EVT);
}
